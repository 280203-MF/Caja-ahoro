import {FormReglas} from "../../molecules"

// eslint-disable-next-line react/prop-types
export const Reglas = ({handleNext ,handlePrevious}) =>{
    ...
    return(
        ...
        <div className="uk-flex uk-flex-column uk-flex-middle ">
            ...
            <h1 className=" uk-text-center uk-text-bold" style={{ fontSize: '20px' , lineHeight: '1', color: '#000000'}}>Reglas</h1>
            <FormReglas/>
